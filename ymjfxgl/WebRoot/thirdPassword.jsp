...
function AfterAdd(result) {
	if (result == "ok") {
		window.top.location.href = "/UserInfo/RevisePwd";
	} else {
		alert(result);
	}
}
			...
			<div class="data_box">
				...
				<div class="listing_box" style="text-align: center; height: 400px">
					...
					<form action="<%=jspName %>" method="post">
						<span>三级密码：</span>
						<input name="thirdpwd" type="password" id="OPass" style="width: 200px;"
							maxlength="20" value="">
						<input type="hidden" name="url" value="/UserInfo/RevisePwd" />
