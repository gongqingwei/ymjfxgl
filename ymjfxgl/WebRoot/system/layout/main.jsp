...
function openLockWindow(){
	var diag = new top.Dialog();
		...
		diag.addButton("btn1","注销系统",function(){
			top.Dialog.confirm("确定要退出系统吗",function(){window.location="<%=path%>/userAction.do?method=logout"});
		})
	...
	<div id="bs_navright">
		<div class="bs_nav">
			...
			<div class="float_right padding_top2 padding_right5">
				...
				<span class="icon_exit hand" onclick='top.Dialog.confirm("确定要退出系统吗",function(){window.location="<%=path%>/system/login/login_classic.html"});'>退出系统</span>
			</div>
			<div class="clear"></div>
		</div>
	</div>
