...
public class User {
	...
	public User(String id, String username, String password, int identity,
			String seondpassword, String thirdpassword, int rengounumber,
			String tuijianrennumber, String baodancenternumber,
			String truename, String phonenumber, String shenfenzhengnumber,
			String adress, String bankmessage, String bankzhihang,
			String bankfenlichu, String kaihuname, String banknumber) {
		super();
		this.id = id;
		this.username = username;
		this.password = password;
