...
<head>
    ...
    <title>无标题文档</title>
    <link href="shangpin/css/list.css" rel="stylesheet" type="text/css">
    <link href="shangpin/css/cart.css" rel="stylesheet" type="
    text/css">
    <link href="shangpin/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <script src="shangpin/js/jquery-1.10.1.min.js"></script>
    <script type="text/javascript" src="shangpin/js/jquery.event.drag-1.5.min.js"></script>
    <script type="text/javascript" src="shangpin/js/jquery.touchSlider.js"></script>
    ...
    <div class="biglayer">
        ...
        <div class="main_visual">
            ...
            <div class="main_image">
                <ul>
                        <li><span class="img_1">
                            <img src="shangpin/images/26c6bfbd-0168-492b-a95b-feda6ae9f39d.jpg" alt="头页" ></span></li>
 								  	...
 								  	<li>
                        					...
                        					<div class="item">
                        						<a href="oneCommodity?commodityId=${commodity.id}">
					                                    <img src="shangpin/images/${commodity.images}" class="shop_img"></a>
